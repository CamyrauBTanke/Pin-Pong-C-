...
simulate_game(Input* input, float dt) {
	clear_screen(0xffaa11);
	draw_rect(0, 0, arena_half_size_x, arena_half_size_y, 0xffaa11);
	...
	draw_rect(80, player_1_p, player_half_size_x, player_half_size_y, 0);
	draw_rect(-80, player_2_p, player_half_size_x, player_half_size_y, 0);
